...
int main(void) {
  int curr_char; /* represent the current character we read */
  ...
  while ((curr_char = getchar()) != EOF) {
    switch(curr_char) {
      case 32: switch(last_char) {case 1: cnt_word++; break;} 
               last_char = 0; break;
      case 10: switch(last_char) {case 1: cnt_word++; break;}
               last_char = 0;
               last_endl = 1; break;
      default: cnt_char++;
               switch(last_endl) {case 1: cnt_endl++; last_endl = 0; break;}
               last_char = 1; break;
    }
  }

  switch(last_char) {
    case 1: cnt_word++; break;
  }
  switch(cnt_word) {
    case 1: cnt_endl++; break;
  }
